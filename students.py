...
class Students:
    ...
    def get_advance_students(students):
        """Method to return advance students under 21 with a grade A"""
    ...
    def get_student_names(students):
        """Method to return students by first and last name"""
        student_names = []
